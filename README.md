...
![image](https://user-images.githubusercontent.com/60325113/118378070-c6a27b80-b5d9-11eb-9864-1bd6b3c21385.png)
...
Количество: 
  * крупные - пиковый трафик 0,4 * 6 858 Мбит/сек / (25 * 2) = 55
  * мелкие - пиковый трафик 0,6 * 6 858 Мбит/сек / (50 * 2) = 42
SSD:
для CDN, хранящих у себя наиболее популярный контент (пусть это будет 5% = 0.05 * 5 609,160 ТБ = 280,45 Тб) - нужно выделить:
  280,45 / 42 = 6,7 Тб - возьмем с запасом по 8 Тб
для CDN, хранящих остальной видео контент, 
  тогда количество SSD - 5 609,160 / 55 = 102 Тб - можно объеденить 100 Тб + 2 Тб
...
| - | - | - | - | - | - |
| Фронтенд | 8 | 64 | 128 Гб | 5 + 10 | Москва и Санкт-Петербург |
| NGINX | 32 | 128 | 256 Гб | 10 + 20 | Москва и Санкт-Петербург |
| Сервис авторизации | 32 | 128 | 256 Гб | 2 + 4 | Москва и Санкт-Петербург |
| Сервис управления контентом | 32 | 128 | 256 Гб | 3 + 6 | Москва и Санкт-Петербург |
| Сервис пользовательских данных | 32 | 128 | 256 Гб | 2 + 4 | Москва и Санкт-Петербург |
| Сервис аналитики | 32 | 128 | 256 Гб | 2 + 4 | Москва и Санкт-Петербург |
| Сервис рекомендаций | 32 | 128 | 256 Гб | 3 + 6 | Москва и Санкт-Петербург |
| Мелкие CDN с популярным контентом | 8 | 512 | 8 Тб | 42 * 2 = 84 | 50 % - Москва и Санкт-Петербург 50 % - остальные крупные города России |
| Крупные CDN | 8 | 512 | 100 Тб + 2 Тб | 55 * 2 = 110 | 50 % - Москва и Санкт-Петербург 50 % - остальные крупные города России |
