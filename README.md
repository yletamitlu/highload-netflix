...
(главная, фильмы, сериалы, популярное) | 3 | чтение | (61 запрос / 6 секунд) * 3 * 1 000 000 / (24 * 60 * 60) = 353 rps |
...
![image](https://user-images.githubusercontent.com/60325113/117884572-75cb1400-b2b5-11eb-888a-5474267b95ed.png)
