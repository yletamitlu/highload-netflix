...
|Пиковая разовая нагрузка (с учетом среднего битрейта)|0,5 \* 1 000 000 чел \* 6350 кбит/сек = 3175 Гб/сек||
...
|Регионы|1 92 0000 \* 0.8558 \* (0.1 \* 7 + 0.3 \*4.2 + 0.3 \* 3 + 0.2 \* 0,7 + 0.1 \* 0.3) = 4 978 702, 08 Гб|1 920 000 \* 0.1442 \* (0.3 \* 3 + 0.4 \* 0,7 +0.3 \* 0.3) = 351 617, 28 Гб|
