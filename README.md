...
SSD: 
для CDN, хранящих у себя наиболее популярный контент (пусть это будет 5% = 9 360 Тб) - можно выделить либо 1 на 10 000 Тб, 
либо несколько, например, по 1000 Тб и объединить по 10 штук в кластер.
для CDN, хранящих остальной видео контент пусть примерно 5 000 Тб, 
  тогда количество SSD - 187 199, 56 / 5 000 = примерно 37.
