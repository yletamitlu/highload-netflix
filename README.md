...
Статика - 6,5 МБ (22 запросов); Динамика - 190 МБ (642 запросов); Изображения - 24.3 МБ (906 запросов)
...
Контент будет храниться на CDN серверах. Расположить их стоит преимущественно в
